                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer">
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Admin Email</label>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row mb-4 custom-dropdown-container">
                                <label class="col-md-2 col-form-label">Admin Role</label>
                                <div class="col-md-4">
...
<script>
    $(document).ready(function(e) {
        ...
        function updateCheckAll() {
            ...
            // Set the "Check All" checkbox state
        ...
        // Initialize the "Check All" checkbox state
        updateCheckAll();
    });
</script>
<script>
