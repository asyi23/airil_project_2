...
@section('title') {{ $title }} User Add @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">{{ $title }} User Add</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item">
                        <a href="javascript: void(0);">User Add</a>
                    </li>
...
<div class="row">
    <div class="col-12">
        <form method="POST" action="{{ $submit }}" enctype="multipart/form-data">
                    ...
                    {{-- <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="confirm_password" type="password" class="form-control" value="{{ @$post->confirm_password }}">
                            </div>
                        </div>
                    </div> --}}
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Seller Info</h4>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select(
                                    'user_state', 
                                    @$user_state_sel ?? @$state_sel, 
                                    @$post->user_state,
                                    ['class' => 'form-control state','id' => 'user_state']) 
                                !!}
                            </div>
                            <div class="form-group">
                                ...
                                {!! Form::select(
                                    'user_city', 
                                    $user_city_sel ?? @$city_sel, 
                                    @$post ? $post->user_city : [],
                                    ['class' => 'form-control','id' => 'user_city'])
                                !!}
                            </div>
                            <div class="form-group">
                                <label for="user_nationality">Nationality<span class="text-danger">*</span></label>
                                <input readonly name="user_nationality" type="text" class="form-control" value="{{ @$post->user_nationality ?? 'Malaysia' }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Seller Type</h4>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div id="company_details" @if(@$post->user_type_id!=2 ?? true) style="display:none"@endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="company_regno" type="text" class="form-control" value="{{ @$post->company_regno }}">
                                </div>
                                <div class="form-group">
                                    <label for="company_phone">Company Phone<span class="text-danger">*</span></label>
                                    <input id="input-mask" name="company_phone" class="form-control input-mask text-left" data-inputmask="'mask': '999-99999999','clearIncomplete':'true','removeMaskOnSubmit':'true'" im-insert="true" style="text-align: right;" value="{{ @$post->company_phone }}">
                                </div>
                                <div class="form-group">
                                    <label for="company_email">Company Email<span class="text-danger">*</span></label>
                                    <input name="company_email" type="email" class="form-control" value="{{ @$post->company_email }}">
                                </div>
                                <div class="form-group">
                                    <label for="company_website">Company Website</label>
                                    <input name="company_website" type="text" class="form-control" value="{{ @$post->company_website }}">
                                </div>
                                <div class="form-group">
                                    <label for="company_address">Company Address<span class="text-danger">*</span></label>
                                    <input name="company_address" type="text" class="form-control" value="{{ @$post->company_address }}">
                                </div>
                                <div class="form-group">
                                    <label for="company_postcode">Company Postcode<span class="text-danger">*</span></label>
                                    <input name="company_postcode" type="text" class="form-control" max="5" value="{{ @$post->company_postcode }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- @if (@$post->hasMedia('user_ic'))
                                        <a href="{{ $post->getFirstMediaUrl('user_ic') }}" class="row col image-popup-vertical-fit mb-2">
                                            <img src="{{ $post->getFirstMediaUrl('user_ic') }}" class="img-fluid img-thumbnail avatar-xl">	
                                        </a>
                                    @endif --}}
                                ...
                                <div class="form-group">
                                    <label class="control-label">Business Card Copy</label>
                                    {{-- @if (@$post->hasMedia('user_business_card'))
                                        <a href="{{ $post->getFirstMediaUrl('user_business_card') }}" class="row col image-popup-vertical-fit mb-2">
                                            <img src="{{ $post->getFirstMediaUrl('user_business_card') }}" class="img-fluid img-thumbnail avatar-xl">	
                                        </a>
                                    @endif --}}
                            ...
                            <div id="sales_agent_details" @if(@$post->user_type_id!=3 ?? true) style="display:none"@endif>
                                <div class="form-group">
                                    ...
                                    <input name="sales_agent_company_regno" type="text" class="form-control" value="{{ @$post->company_regno ?? @$post->sales_agent_company_regno ?? @$post->user_company->company_regno ?? @$post->join_company->company_regno }}">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Identification Card Copy</label>
