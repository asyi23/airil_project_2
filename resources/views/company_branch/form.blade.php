                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="department_id" maxlength="100" class="form-control" value="{{$department->department_name}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="department_equipment_name" type="text" maxlength="100" class="form-control" value="{{ @$post->department_equipment_name }}">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-9 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('company_branch_listing', $department->department_id) }}" class="btn btn-secondary" type="button">Cancel</a>
                </div>
            </div>
        </div>
    </div>
