...
<div class="row">
    <div class="col-12">
        {{-- <form method="POST" action="{{ $submit }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="car_catalog_name" type="text" name="car_catalog_name" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="car_catalog_type">Catalog Type</label>
                                <select name="car_catalog_type" class="form-control select2" id="car_catalog_type">
            ...
            <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Catalog Image</h4>
                        <div class="row">
                            <div class="col-sm-12">
                            <input type="file" class="form-control" name="catalog_images" @error('catalog_images') is-invalid @enderror>
                            </div>
