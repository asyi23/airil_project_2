...
@section('title') Edit Ad Verification Inspection @endsection
...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-flex align-items-center justify-content-between">
			<h4 class="mb-0 font-size-18">Edit Inspection list</h4>
			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					<li class="breadcrumb-item">
						<a href="javascript: void(0);">Edit Ad Inspection list</a>
					</li>
        ...
        <div class="col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 inspection">
                                                                    <li class="custom-control custom-checkbox" style="list-style:none;">
                                                                        <input class="custom-control-input check" type="checkbox" name="setting_inspection_list_ids[{{ $sub_list->setting_inspection_list_id }}]" id="{{ $sub_list->setting_inspection_list_id }}"
                                                                        @if($post->setting_inspection_list_ids[$sub_list->setting_inspection_list_id] ?? false)
                                                                        checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control"
                                                                           name="setting_inspection_list_description[{{ $sub_list->setting_inspection_list_id }}]"
                                                                           value="{{ $post->setting_inspection_list_description[$sub_list->setting_inspection_list_id] ?? null }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                        ...
                        <div class="repeater">
                            <div data-repeater-list="ads_inspection_list_notes">
                                ...
                                @if(@$post->ads_inspection_list_notes )
                                    @foreach($post->ads_inspection_list_notes as $list_notes)
                                    @php
                                        $list_notes = (object)$list_notes;
                                    @endphp
                                    <div data-repeater-item class="row">
                                        <div  class="form-group col-6 col-md-2">
                                            <label for="name">Section</label>
                                            <input type="text" name="inspection_section" class="form-control" value="{{ $list_notes->inspection_section}}" />
                                        </div>
                                        <div  class="form-group col-6 col-md-2">
                                            <label for="name">Item</label>
                                            <input type="text" name="inspection_item" class="form-control" value="{{ $list_notes->inspection_item }}" />
                                        </div>
                                        <div  class="form-group col-md-6">
                                            <label for="name">Notes</label>
                                            <input type="text" name="inspection_notes" class="form-control" value="{{ $list_notes->inspection_notes}}" />
                                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="submit" name="submit" value="update" class="btn btn-success waves-effect waves-light mr-1">Update</button>

                    <a id="cancel" href="{{ route('ads_listing') }}" class="btn cars-btn-default mb-2 mb-sm-0">Cancel</a>
            </div>
        </div>
    </div>
</form>
