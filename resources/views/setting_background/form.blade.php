...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">{{ $title }} Background</h4>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Background Detail</h4>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="background_name">Background Name<span class="text-danger">*</span></label>
                            <input name="background_name" type="text" maxlength="90" class="form-control" value="{{ @$post->background_name }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Background Image</h4>
                <div class="row">
                    <div class="col-sm-6">
                        @php
                            $background = $setting_background->getMedia('background_image')->last();

                        @endphp
                        <div id="BackgroundImgContainer"style="margin-bottom: 10px; display: {{ $background ? 'block' : 'none' }};overflow:hidden;" >
                            <img id="BackgroundImgPreview"
                            src="{{$background ? $background->getUrl() : ''  }}"
                            height="70" width="100" style="margin-bottom: 5px;cursor: pointer;" class="background-clickable">
                        </div>
                        <div class="input-group">
                            <input type="file" class="custom-file-input" style="width: 100%;" accept=".jpeg,.png,.jpg,.gif"
                                name="background_image" id="background_image" onchange="updateImagePreview(this);updateLabelWithFileName(this)" multiple
                            ...
                            <label class="custom-file-label"
                                ...
                                white-space: nowrap;"
                                for="exampleInputFile">Select Background Image
                            </label>
                        </div>
                    </div>
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" style="width: 100%; margin-bottom:10px;" accept=".jpeg,.png,.jpg,.gif"
                                        name="background_image" id="background_image" onchange="updateImageCountAndPreviews(this)" multiple
                                        @error('background_image') is-invalid @enderror>
                                    <label class="custom-file-label"
                                        id="background_image"
                                        style=" overflow: hidden;
                                        text-overflow: ellipsis;
                                        white-space: nowrap;"
                                        for="exampleInputFile">Select Background Image</label>
                                </div>
                            </div>
                        @error('background_image')
                        <span class="invalid-feedback" role="alert">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <a href="{{ route('setting_background_listing') }}" class="btn btn-secondary" type="button">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function updateImagePreview(input) {
        const preview = document.getElementById('BackgroundImgPreview');
        const container = document.getElementById('BackgroundImgContainer');
    ...
    const label = document.querySelector('label[id = "background_image"]');
    if (input.files.length > 0) {
        label.textContent = input.files[0].name;
    } else {
        label.textContent = "Select Background Image";
    }
}
</script>
<script>
    ...
    var Backgroundimages = document.querySelector(".background-clickable");

    Backgroundimages.onclick = function(){
...
<script>
    ...
    function showImagePreview(imageUrl) {
            ...
            const modalImage = document.getElementById("backgroundImg");
