                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="department_equipment_id" maxlength="100" class="form-control" value="{{$safety_and_health->safety_and_health_name}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="safety_and_health_record_name" type="text" maxlength="100" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-9 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('saftey_and_health_record_listing', $id) }}" class="btn btn-secondary" type="button">Cancel</a>
                </div>
            </div>
        </div>
    </div>
