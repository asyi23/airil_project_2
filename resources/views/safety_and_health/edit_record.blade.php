...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">{{ $title }} Health and safety record </h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item">
                        <a href="javascript: void(0);">Health and safety record</a>
                    </li>
...
<form method="POST" action="{{$submit}}" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Safety And Health Record Details</h4>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="department_id">Safety And Health Name<span class="text-danger">*</span></label>
                                <input type="text" name="department_equipment_id" maxlength="100" class="form-control" value="{{$safety_and_health_record->safety_and_health->safety_and_health_name}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="safety_and_health_record_name">Safety And Health Record Name <span class="text-danger">*</span></label>
                                <input name="safety_and_health_record_name" type="text" maxlength="100" class="form-control" value="{{ @$safety_and_health_record->safety_and_health_record_name }}">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class=" col-xl-9 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('saftey_and_health_record_listing', $safety_and_health_record->safety_and_health_id) }}" class="btn btn-secondary" type="button">Cancel</a>
                </div>
            </div>
        </div>
    </div>
