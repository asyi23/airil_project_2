            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item">
                        <a href="javascript: void(0);">Safety And Health</a>
                    </li>
                        ...
                        <table id="tech-companies-1" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{$no++}}</th>
                                    <td>
                                        <b>{{ @$rows->safety_and_health_name }}</b>
                                    </td>
                                    <td>
                                        <div class="button-container" style="display: flex;gap:10px">
                                            <a href="{{ route('saftey_and_health_record_listing', $rows->safety_and_health_id) }}" class="btn btn-sm btn-outline-primary mb-2">Manage Record </a>
                                        </div>
                                    </td>
                                </tr>
                                @empty
