                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="department_name" maxlength="100" class="form-control" value="{{$department_equipment->department->department_name}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="form_detail_remark" type="text" class="form-control"
                                    rows="10">{{$form_detail->form_detail_remark}}</textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="form_detail_oum">OUM<span class="text-danger">*</span></label>
                                <input name="form_detail_oum" type="text" maxlength="100" class="form-control" value="{{$form_detail->form_detail_oum}}">
                            </div>
                        </div>
                    </div>
                </div>
