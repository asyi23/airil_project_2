...
$con=mysqli_init(); mysqli_ssl_set($con, NULL, NULL, <ca-cert-filename>, NULL, NULL); mysqli_real_connect($con, "SG-cut-dye-4165-12478-mysql-master.servers.mongodirector.com", "<user>", "<password>", "<your-database-name>", 3306)
                <style>
                    .combined-input {
                        display: flex;
                        align-items: center;
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">{{ $title }} Form Name (Part Name)</h4>
                ...
                <form method="POST" action="{{$submit}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Department Equipment Details</h4>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="department_id">Department Equipment Name<span class="text-danger">*</span></label>
                                                <input type="text" name="department_equipment_id" maxlength="100" class="form-control" value="{{$department_equipment->department_equipment_name}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="form_name">Form Name (Part Name)<span class="text-danger">*</span></label>
                                                <input name="form_name" type="text" maxlength="100" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('form_listing', $id) }}" class="btn btn-secondary" type="button">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
