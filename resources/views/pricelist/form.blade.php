    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">{{ $title }} Custom Pricelist</h4>
        ...
        <div class="row">
            ...
            @if ($action === 'edit')
                <div class="col-xl-3 col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Upload Custom Pricelist</h4>
                            <div id="pricelist_media">
                                @php
                                    $Pricelist = $pricelist->getMedia('pricelist_media')->last();
                                @endphp
                                <label for="pricelist_media">Custom Pricelist</label><span class="text-danger">*</span>
                                <div id="PricelistContainer" style="margin-bottom: 5px; display: {{ $Pricelist ? 'flex' : 'none' }};align-items:center">
                                    ...
                                    <a class="closeButton" id="pricelistCloseButton" data-modal-message="Pricelist"  data-pricelist-id="{{ @$post->pricelist_id }}" data-file-name="pricelist_media"style="cursor: pointer;margin-left:20px"><i style="color: red;font-size:18px" class='bx bx-trash'></i></a>
                                </div>
                                <div class="input-group">
                                    <input type="file" class="custom-file-input"
                                        style="width: 100%;" name="pricelist_media"
                                        id="pricelist_media" accept=".pdf"
                                        onchange=" updateImagePreview(this, 'PricelistPreview','PricelistContainer', 'pricelistCloseButton'), updateLabelWithFileName(this, 'pricelist_media_label')"
                                        @error('pricelist_media') is-invalid @enderror>
                                    <label class="custom-file-label" id="pricelist_media_label"
                                        style=" overflow: hidden;
                                    text-overflow: ellipsis;
                                    white-space: nowrap;"
                                        for="exampleInputFile">Select  Pricelist
                                    </label>
                                </div>
                                    ...
                                    <div id="pricelist_media">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="custom-file-input"
                                                style="width: 100%;" name="pricelist_media"
                                                id="pricelist_media" accept=".pdf"
                                                onchange="updateLabelWithFileName(this, 'pricelist_media_label')"
                                                multiple @error('pricelist_media') is-invalid @enderror>
                                            <label class="custom-file-label" id="pricelist_media_label"
                                                style=" overflow: hidden;
                                            text-overflow: ellipsis;
                                            white-space: nowrap;"
            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('pricelist_listing') }}" class="btn btn-secondary"
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" action="{{route('pricelist_remove_upload')}}">
                    @csrf
                    <div class="modal-body">
                        <h4 style="margin-bottom: 10px">Remove This ?</h4>
                        <input type="hidden" name="pricelist_id" id="pricelist_id_modal">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Set the initial state of "Check All" for card 1 based on whether all other checkboxes are checked
        ...
        function updateLabelWithFileName(input, labelId) {
            ...
            if (input.files[0].size > maxSize) {
                ...
                if (input.files.length > 0) {
                    ...
                    label.textContent = `Select : 'Pricelist'}`;
                }
            }
        }
    </script>
    ...
    <script>
        ...
        var pricelistModalImg = document.getElementById("Img");

        var pricelistImages = document.querySelectorAll(".pricelist-clickable");
        ...
        var pricelistCloseButton = document.getElementById("closeModal");
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            closeButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    const pricelistId = this.getAttribute("data-pricelist-id");

                    // Update the value of the hidden input field in the modal
                    modal.querySelector("#pricelist_id_modal").value = pricelistId;
            ...
            function updateBranchAndModel(){
                if (companySelect.val() === ""){
                    ...
                    @if (Auth::user()->user_type->user_type_slug == 'admin') {
                        ...
                        $.ajax({
                            url: "{{ route('pricelist_get.car_model', '') }}/" + companyId,
                            method: 'GET',
                            success: function(data) {
                                var newHtmlContent1 = `
                                <div class="card-body">
